...
public final class FAWAnimations {
    ...
    private static <E extends AbstractThingEntity> void frozen(AnimationState<E> event, E thing){
    ...
    private static <E extends AbstractThingEntity> void movement(AnimationState<E> event, E thing){
    ...
    private static <E extends AbstractThingEntity> void generic(AnimationState<E> event,
                                                                E thing,
    ...
    public static <E extends AbstractThingEntity> AnimationController<E> genericThing(E thing,
                                                                         String name,
                                                                         BiConsumer<AnimationState<E>, E> frozen,
                                                                         BiConsumer<AnimationState<E>, E> movement,
                                                                         BiConsumer<AnimationState<E>, E> idle){
    ...
    public static <E extends AbstractThingEntity> AnimationController<E> defaultThing(E thing){
    ...
    public static <E extends AbstractThingEntity> AnimationController<E> defaultThingNoChase(E thing){
        return genericThing(thing,
                "DefaultThingNoChase",
                FAWAnimations::frozen,
