...
public class Impaler extends ResizeableThing implements BurstAttackThing {
    ...
    public Impaler(EntityType<? extends Impaler> entityType, Level world) {
    ...
    static {
        BACK_NEEDLES = SynchedEntityData.defineId(Impaler.class, EntityDataSerializers.BOOLEAN);
        MOUTH_NEEDLES = SynchedEntityData.defineId(Impaler.class, EntityDataSerializers.BOOLEAN);
    }
